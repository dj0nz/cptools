...
# To modify firewall topology in management database, please run eth2bond-mgmt.sh before this script.
# Make sure, VLANs and bond are identical in both scripts.
#
